...
import { Briefcase, MapPin, Clock, ArrowRight, FileText, Sparkles, CheckCircle2 } from 'lucide-react'
...
const CandidateDashboard = () => {
    ...
    const stats = [
        { label: "Applications", value: appliedJobs.length, icon: FileText },
        { label: "Interviews", value: appliedJobs.filter(a => a.status === 'interview').length, icon: Sparkles },
        { label: "Accepted", value: appliedJobs.filter(a => a.status === 'accepted').length, icon: CheckCircle2 },
    ];
